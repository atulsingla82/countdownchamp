A Countdown clock that lets you countdown to a date of your choice. Bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
